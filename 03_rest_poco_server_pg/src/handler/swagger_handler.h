...
info:
  ...
  description: REST API server with POCO + PostgreSQL
  version: 2.0.0
servers:
  - url: /
paths:
    ...
    get:
      ...
      parameters:
        - name: first_name
          ...
          schema:
            type: string
          description: Substring/terms search in first_name
        - name: last_name
          in: query
          required: false
          schema:
            type: string
          description: Substring/terms search in last_name
        - name: organization
          in: query
          required: false
          schema:
            type: string
          description: Substring/terms search in organization name
      responses:
        '200':
          description: Success
          content:
